...
var _default = function _default(Group) {
  var GroupContainer = /*#__PURE__*/function (_Component) {
    ...
    function GroupContainer(props) {
      ...
      _this.addRule = function () {
        var defaultPropertiesRule = {};

        if (_this.props.config.settings.defaultPropertiesRule) {
          defaultPropertiesRule = _objectSpread(_objectSpread({}, defaultPropertiesRule), _this.props.config.settings.defaultPropertiesRule);
        }

        _this.props.actions.addRule(_this.props.path, defaultPropertiesRule);
      };
      ...
      _this.setProperty = function (property, value) {
        _this.props.actions.setProperty(_this.props.path, property, value);
      };
    ...
    _createClass(GroupContainer, [{
      ...
      value: function render() {
        ...
        }, [isDraggingMe ? /*#__PURE__*/_react["default"].createElement(ClassComponent, {
          key: "dragging",
          id: this.props.id,
          isDraggingMe: true,
        ...
        }) : null, /*#__PURE__*/_react["default"].createElement(ClassComponent, {
          key: this.props.id,
          id: this.props.id,
  ...
  GroupContainer.propTypes = {
    classComponent: _propTypes["default"].elementType,
