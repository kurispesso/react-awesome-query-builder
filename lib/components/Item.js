...
var typeMap = {
  rule: function rule(props) {
    ...
    if (props.config.settings.classRule) {
      renderProps.classComponent = (0, _Draggable["default"])("rule")(props.config.settings.classRule);
    }
  ...
  group: function group(props) {
    ...
    if (props.config.settings.classGroup) {
      renderProps.classComponent = (0, _Draggable["default"])("group")(props.config.settings.classGroup);
    }
  ...
  rule_group: function rule_group(props) {
    ...
    if (props.config.settings.classRuleGroup) {
      renderProps.classComponent = (0, _Draggable["default"])("group rule_group")(props.config.settings.classRuleGroup);
    }
