  ...
  rule: function rule(props) {
    ...
    if (props.config.settings.classRule) {
      if (!cacheTypeMap[props.config.settings.classRule]) {
        cacheTypeMap[props.config.settings.classRule] = (0, _Draggable["default"])("rule")(props.config.settings.classRule);
      }
  ...
  group: function group(props) {
    ...
    if (props.config.settings.classGroup) {
      if (!cacheTypeMap[props.config.settings.classGroup]) {
        cacheTypeMap[props.config.settings.classGroup] = (0, _Draggable["default"])("group")(props.config.settings.classGroup);
      }
  ...
  rule_group: function rule_group(props) {
    ...
    if (props.config.settings.classRuleGroup) {
      if (!cacheTypeMap[props.config.settings.classRuleGroup]) {
        cacheTypeMap[props.config.settings.classRuleGroup] = (0, _Draggable["default"])("group rule_group")(props.config.settings.classRuleGroup);
      }
