...
var typeMap = {
  rule: function rule(props) {
    ...
    if (props.config.settings.classRule) {
      Container = (0, _RuleContainer["default"])((0, _Draggable["default"])("rule")(props.config.settings.classRule));
    } else {
      Container = _Rule["default"];
    }

    return /*#__PURE__*/_react["default"].createElement(Container, renderProps);
  },
  group: function group(props) {
    ...
    if (props.config.settings.classGroup) {
      Container = (0, _GroupContainer["default"])((0, _Draggable["default"])("group")(props.config.settings.classGroup));
    } else {
      Container = _Group["default"];
    }
  ...
  rule_group: function rule_group(props) {
    ...
    if (props.config.settings.classRuleGroup) {
      Container = (0, _GroupContainer["default"])((0, _Draggable["default"])("group rule_group")(props.config.settings.classRuleGroup));
    } else {
      Container = _RuleGroup["default"];
    }
