...
var validateAndFixTree = function validateAndFixTree(newTree, _oldTree, newConfig, oldConfig) {
  ...
  var tree = (0, _validation.validateTree)(newTree, _oldTree, newConfig, oldConfig, removeEmptyGroups, removeInvalidRules);
