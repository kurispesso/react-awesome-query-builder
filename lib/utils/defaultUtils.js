...
var defaultRuleProperties = function defaultRuleProperties(config) {
  ...
  if (config.settings.defaultPropertiesRule) {
    defaultPropertiesRule = _objectSpread(_objectSpread({}, defaultPropertiesRule), config.settings.defaultPropertiesRule);
  }

  var current = new _immutable["default"].Map(_objectSpread(_objectSpread({}, defaultPropertiesRule), {}, {
    field: field,
    operator: operator,
